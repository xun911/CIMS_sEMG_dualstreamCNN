    ...
    acc = one_fold_intra_subject_eval.vote_accuracy_curves(
        [Exp(dataset=Dataset.from_name('ninapro-db1-rawdata-semgfeature-multisource'),
             ...
             Mod=dict(num_gesture=53,
                      ...
                      params='.cache/ninapro-db4-rawsemg_feature_multisource_multistream_sigimgv2-20-1-one-fold-intra-subject-fold-%d-v1.0.0.1/model-0028.params'))],
        folds=np.arange(8),
