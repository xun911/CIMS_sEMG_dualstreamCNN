...
logger = Logger('high-density-emg')
...
@click.option('--feature-name', type=click.Choice(['rawimg_dy','rawimg',
                                                   'piece_multistream',
                                                   'block_multistream',
                                                   'block_multistream_v2',
                                                   'block_diff_multistream',
                                                   'block_piece_multistream',
                                                   'block_plusrawimg_multistream',
                                                   'piece_multistream_v2',
                                                   'piecesigimg_multistream',
                                                   'piece_multistream_twoaxis',
                                                   'piece_plusrawimg_multistream',
                                                   'singleframe_multistream',
                                                   'rawimg_fftimg_multistream',
                                                   'piece_multistream_overlap'
                                                   ]), required=True)
@click.option('--dataset', type=click.Choice(['s21', 'csl',
                                              'dba', 'dbb', 'dbc',
                                              'csliter', 'capgmyoiter',
                                              'capgmyoiter-dbb']), required=True)
...
def crossval(args):
    ...
    with Context(args.log, parallel=True):
        ...
        if args.feature_name == 'rawimg_dy':
        ...
        elif args.feature_name == 'piece_multistream' or args.feature_name == 'piece_multistream_v2':   
             semg_rows = train.shapes1             
             semg_cols = train.shapes2     
        elif args.feature_name == 'piecesigimg_multistream':   
             semg_rows = []             
             for i in range(len(train.shapes)):
                   semg_rows.append(1)             
             semg_cols = train.shapes 
        elif args.feature_name == 'piece_multistream_twoaxis':   
             semg_rows = []             
             for i in range(len(train.shapes)):
                   semg_rows.append(1)             
             semg_cols = train.shapes     
        elif args.feature_name == 'piece_plusrawimg_multistream':
             semg_rows = train.shapes1             
             semg_cols = train.shapes2  
        elif args.feature_name == 'block_plusrawimg_multistream':
             semg_rows = train.shapes1             
             semg_cols = train.shapes2 
        elif args.feature_name == 'block_multistream':
             semg_rows = train.shapes1             
             semg_cols = train.shapes2 
        elif args.feature_name == 'block_diff_multistream':
             semg_rows = train.shapes1             
             semg_cols = train.shapes2
        elif args.feature_name == 'block_piece_multistream':
             semg_rows = train.shapes1             
             semg_cols = train.shapes2  
        ...
        elif args.feature_name == 'rawimg_fftimg_multistream':
             semg_rows = train.shapes1             
             semg_cols = train.shapes2
        elif args.feature_name == 'piece_multistream_overlap':
             semg_rows = train.shapes1             
             semg_cols = train.shapes2     
        else:
             semg_rows = 1
