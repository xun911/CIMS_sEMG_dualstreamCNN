...
class CapgMyoBlockWiseMultiStreamData(mx.io.NDArrayIter):
...
#        self.num_channel = 1    
        ...
        super(CapgMyoBlockWiseMultiStreamData, self).__init__(*args, **kargs)
...
#             print res[0].shape
    ...
    def reset(self):
        self._reset()
        super(CapgMyoBlockWiseMultiStreamData, self).reset()
