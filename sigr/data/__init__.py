...
class Dataset(object):
    ...
    def get_dataiter(self, *args, **kargs):
        return get_data(*args, **kargs)
...
from . import capgmyo, ninapro, csliter, capgmyoiter
assert capgmyo and ninapro and csliter and capgmyoiter
