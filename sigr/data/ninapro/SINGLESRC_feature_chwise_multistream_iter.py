...
class ChwiseFeatureMultiStreamIter(mx.io.NDArrayIter):
...
#        self.feature_list = kargs.pop('feature_list')
        ...
        super(ChwiseFeatureMultiStreamIter, self).__init__(*args, **kargs)
...
#             print res[0].shape                         
    ...
    def reset(self):
        self._reset()
        super(ChwiseFeatureMultiStreamIter, self).reset()
