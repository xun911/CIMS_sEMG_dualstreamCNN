...
#    feature_extraction_winstride = constant.FEATURE_EXTRACTION_WIN_STRIDE   
    ...
    semg_root = '/code/datasets/ninapro-db4/data' 
#    semg_root = None


    feature_root = ('/data/ninapro-feature/ninapro-db4-downsample20-var-raw-prepro-lowpass-win-%d-stride-%d/' % (feature_extraction_winlength, 
