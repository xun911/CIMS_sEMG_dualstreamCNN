...
class FeatureSigImgData(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(FeatureSigImgData, self).__init__(*args, **kargs)

        
        assert (self.data[0][1].shape[3] == self.num_semg_col*self.num_semg_row)    
        
        self.shape1 = self.data[0][1].shape[2]
        self.shape2 = len(genIndex(self.num_semg_col*self.num_semg_row))-1        
...
#             print res[0].shape
    ...
    def reset(self):
        self._reset()
        super(FeatureSigImgData, self).reset()
