...
sigimg_index = genIndex(10)

class ChwiseFeature_TwoStreamFeatureSigImgv2_Iter(mx.io.NDArrayIter):
...
#        self.feature_list = kargs.pop('feature_list')
        ...
        super(ChwiseFeature_TwoStreamFeatureSigImgv2_Iter, self).__init__(*args, **kargs)
...
#             print res[0].shape
             ...
             res_.append(self._get_sigimg(data_1))
             res_.append(self._get_sigimg(data_2))
             res_.append(self._get_sigimg(data_3))
...
#             print len(self.num_channel)                      
    ...
    def reset(self):
        self._reset()
        super(ChwiseFeature_TwoStreamFeatureSigImgv2_Iter, self).reset()
