...
#        self.shapes2.append(1)
        ...
        self.shapes1.append(20)
        self.shapes2.append(12) 
...
#             print res[0].shape     
             ...
             res_ = [] 
#             print res[0].shape
             temp_data = res[1].asnumpy() if isinstance(res[1], mx.nd.NDArray) else res[1]
             data_1 = temp_data
...
#             res_.append(self._get_sigimg(data_5))      
             ...
             data_2 = temp_data
             res_.append(data_2.reshape(data_2.shape[0], 1, data_2.shape[1], data_2.shape[2]))
#             res_.append(self._get_sigimg(data_2))
