...
class ChwiseFeatureMultiStreamIter_deepfusion(mx.io.NDArrayIter):
...
#        self.feature_list = kargs.pop('feature_list')
        ...
        super(ChwiseFeatureMultiStreamIter_deepfusion, self).__init__(*args, **kargs)
...
#        self.shape2 = self.num_semg_col*self.num_semg_row
        ...
        total_ch = self.num_semg_col*self.num_semg_row*2
        self.num_channel = []
        self.shapes = []        
...
#             print res[0].shape                         
    ...
    def reset(self):
        self._reset()
        super(ChwiseFeatureMultiStreamIter_deepfusion, self).reset()
