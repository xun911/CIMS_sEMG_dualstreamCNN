...
class FeatureSigImgData_v2_deepfusion(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(FeatureSigImgData_v2_deepfusion, self).__init__(*args, **kargs)

        
        assert (self.data[0][1].shape[3] == self.num_semg_col*self.num_semg_row)    
        
        self.num_channel = [self.data[0][1].shape[2], self.data[0][1].shape[2]] 
        kk = len(genIndex(self.num_semg_col*self.num_semg_row))-1
        self.shapes1 = [kk, kk]
        self.shapes2 = [1, 1]        
...
#        print res[1].shape
    ...
    def reset(self):
        self._reset()
        super(FeatureSigImgData_v2_deepfusion, self).reset()
