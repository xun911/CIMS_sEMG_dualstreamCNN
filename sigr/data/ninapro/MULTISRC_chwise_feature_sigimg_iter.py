...
class ChwiseFeature_SigImg_Iter(mx.io.NDArrayIter):
...
#        self.feature_list = kargs.pop('feature_list')
        ...
        super(ChwiseFeature_SigImg_Iter, self).__init__(*args, **kargs)
        ...
        self.shapes1.append(self.data[0][1].shape[2])
        self.shapes2.append(len(genIndex(self.num_semg_col*self.num_semg_row))-1)          
...
#             print len(self.num_channel)                      
    ...
    def reset(self):
        self._reset()
        super(ChwiseFeature_SigImg_Iter, self).reset()
