...
class ChwiseFeature_SigImgv2_Iter(mx.io.NDArrayIter):
...
#        self.feature_list = kargs.pop('feature_list')
        ...
        super(ChwiseFeature_SigImgv2_Iter, self).__init__(*args, **kargs)
...
#             print len(self.num_channel)                      
    ...
    def reset(self):
        self._reset()
        super(ChwiseFeature_SigImgv2_Iter, self).reset()
