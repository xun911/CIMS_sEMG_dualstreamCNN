...
#def get_segment_vote_accuracy_processprob(segment_label, segment_predictions, window):
#    def gen():
#        
#        tmp = window
#        if tmp == -1:
#            tmp = segment_predictions.shape[0]
#        tmp = min(tmp, segment_predictions.shape[0])
#        for begin in range(segment_predictions.shape[0] - tmp + 1):
#            true =               
#            
#        
#        count = {
