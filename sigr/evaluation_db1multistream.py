...
class CrossValEvaluation(Evaluation):
    ...
    def accuracy_exp(self, exp, fold, feature_name, window, num_semg_row, num_semg_col):
    ...
    def accuracies(self, exps, folds, feature_name, window, num_semg_row, num_semg_col):
        acc = []
        for exp in exps:
            for fold in folds:
                acc.append(self.accuracy(exp=exp, fold=fold, feature_name=feature_name, window=window, num_semg_row=num_semg_row, num_semg_col=num_semg_col))
