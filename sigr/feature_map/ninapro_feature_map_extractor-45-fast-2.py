...
input_path = '/home/weiwentao/data/ninapro-db1'
...
feature_list = ['dwpt2d_mean', 'dwpt2d_sd', 'dwpt2d_energy', 'dwpt2d_skewness', 'dwpt2d_kurtosis', 'dwpt2d_m2', 'dwpt2d_m3', 'dwpt2d_m4']        
...
def extract_emg_feature(x, feature_name):
    ...
    if (feature_name.find('2D') != -1) or (feature_name.find('2d') != -1):
...
#    feature_dim = pre_data.shape[1]
    ...
    Parallel(n_jobs=12)(delayed(emg_feature_extraction_parallel_2)(input_path, output_path, combo, feature_list) for combo in combos)     
