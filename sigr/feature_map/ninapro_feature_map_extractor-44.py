...
#feature_list = ['arr_mean','arr_std', 'arr_Range', 'arr_Rangen','arr_H', 'arr_meanraise','arr_stdraise', 'arr_offon', 'arr_offset']

#feature_list = ['arr_mean','arr_std', 'arr_Range', 'arr_Rangen']

feature_list = ['arr_Range', 'arr_Rangen']
