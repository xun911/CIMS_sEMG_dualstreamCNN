...
@click.option('--feature-name', type=click.Choice(['actimg','sigimg',
                                                   ...
                                                   'chwise_feature_multistream_v2',
                                                   'chwise_feature_multistream_deepfusion',
                                                   'chwise_feature_rawimg_multistream',
                                                   'chwise_feature_rawimg_multistream_v2',
                                                   'sigimg_chwise_feature',
                                                   'sigimgv2_chwise_feature',
                                                   'featuresigimg',
                                                   'featuresigimg_v2',
                                                   'featuresigimg_v2_deepfusion',
                                                   'chwise_feature_featuresigimgv2_multistream',
                                                   'chwise_feature_2streamfeaturesigimgv2_multistream',
                                                   'rawsemg_feature_multisource_multistream_sigimgv2']), required=True)
...
#             semg_cols = train.shape_1
             ...
             semg_rows = [args.window, args.window]
             semg_cols = train.shapes
        elif args.feature_name == 'frame_multistream' or args.feature_name == 'subwin_multistream' or args.feature_name == 'rawsemg_feature_multisource_multistream_sigimgv2' or args.feature_name == 'chwise_feature_2streamfeaturesigimgv2_multistream': 
             semg_rows = train.shapes1
             semg_cols = train.shapes2
        ...
        elif args.feature_name == 'chwise_feature_multistream' or args.feature_name == 'chwise_feature_multistream_v2' or args.feature_name == 'chwise_feature_multistream_deepfusion':
             semg_rows = []             
             for i in range(len(train.shapes)):
                   semg_rows.append(1)             
             semg_cols = train.shapes
        elif args.feature_name == 'chwise_feature_rawimg_multistream' or args.feature_name == 'chwise_feature_rawimg_multistream_v2':
             semg_rows = []             
             for i in range(len(train.shapes)):
                   semg_rows.append(1)             
             semg_cols = train.shapes  
        elif args.feature_name == 'sigimg_chwise_feature' or args.feature_name == 'sigimgv2_chwise_feature' or args.feature_name == 'featuresigimg_v2_deepfusion' or args.feature_name == 'chwise_feature_featuresigimgv2_multistream':
             semg_rows = train.shapes1
             semg_cols = train.shapes2
        elif args.feature_name == 'featuresigimg' or args.feature_name == 'featuresigimg_v2':     
             semg_rows = train.shape1
             semg_cols = train.shape2
        else:
             semg_rows = 1
